  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.container}>
        <CalculationComponent memoryValue={memoryValue} operatorValue={operatorValue} answerValue={answerValue} operatorList={operatorList} buttonList = {buttonList} readyToPlace={readyToPlace} pressedEqual={pressedEqual} styles={styles}/>
        <ResultComponent memoryValue={memoryValue} operatorValue={operatorValue} answerValue={answerValue} operatorList={operatorList} buttonList = {buttonList} readyToPlace={readyToPlace} pressedEqual={pressedEqual} styles={styles} />
