  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.container}>
        <Text style={styles.result}>34</Text>

        <View style={styles.row}>
          <TouchableOpacity style={[styles.button, styles.toprow]}>
          ...
          <TouchableOpacity style={[styles.button, styles.siderow]}>
        ...
        <View style={styles.row}>
          <TouchableOpacity style={styles.button}>
            <Text style={styles.action}> C </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button}>
            <Text style={styles.action}> +/- </Text>
          </TouchableOpacity>
